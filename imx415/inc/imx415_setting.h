...
#define GAIN_PGC0   (0x3090)
#define GAIN_PGC1   (0x3092)
#define GAIN_PGC2   (0x3094)
#define GAIN_PGC3   (0x3094)


#define IMX415_VMAX (0x3024)//[19:0]
...
static uint32_t imx415_init_3840x2160_dol2_4lane_setting[] = {
	//  IMX415-AAQR Window cropping 3840x2160 CSI-2_2lane 24MHz AD:10bit Output:10bit 1440Mbps Master Mode 30.005fps Integration Time 10.002ms Gain:6dB Ver12.0
	0x3000, 0x01, // STANDBY
	0x3001, 0x00, // REGHOLD
	0x3002, 0x01, // XMSTA
	0x3003, 0x00, // XMASTER
	...
	0x3046, 0xE0, // PIX_VWIDTH[12:0]
	0x3047, 0x10, // PIX_VWIDTH[12:0]
	0x3050, 0x2A, // SHR0[19:0]
	0x3051, 0x09, // SHR0[19:0]
	0x3052, 0x00, // SHR0[19:0]
	...
	0x311B, 0x00, // INCKSEL4[10:0]
	0x311E, 0x23, // INCKSEL5[7:0]
	0x3260, 0x00, // GAIN_PGC_FIDMD: 00h=per-frame gain valid
	0x32C8, 0x01, // -
	0x32D4, 0x21, // -
	0x32EC, 0xA1, // -
	0x344C, 0x2B, // -
